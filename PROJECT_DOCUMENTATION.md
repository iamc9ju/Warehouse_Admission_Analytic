...
- Dashboard social metrics now exclude synthetic/sample platforms and display only real/collected sources: YouTube Data API plus the small manual Facebook public-search sample
...
- Dashboard ไม่แสดง synthetic/sample social data แล้ว จะแสดงเฉพาะ sources ที่เก็บจริงหรือดึงจาก API จริงเท่านั้น
